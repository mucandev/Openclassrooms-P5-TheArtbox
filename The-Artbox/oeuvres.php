...
$oeuvres = [
    ...
    */
    [
        "id" => 1,
        "enabled" => true,
        "visuel" => "clark-van-der-beken.png",
        "title" => "Dodomu",
        "author" => "Mia Tozerski",
    ...
    [
        "id" => 2,
        "enabled" => true,
        "visuel" => "pawel-czerwinski-3.png",
        "title" => "Aashaaheen Baadal",
        "author" => "Anaisha Devi",
        "description" => "Sur cette oeuvre conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte dans un nuage noir envoûtant. Un sombre tableau qui, par son vernis éclatant, rayonne tel un marbre poli. Une oeuvre à la cohérence transcendantale, exécutée à la perfection.",
    ],
    [
        "id" => 3,
        "enabled" => true,
        "visuel" => "dan-cristian-padure.png",
